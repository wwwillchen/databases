  ...
  it("Should insert posted messages to the DB", function(done) {
    ...
    request({method: "POST",
            ...
            function () {
              ...
              console.log(request);
              var queryString = "INSERT INTO messages (user_id, textMessage, roomname) values ('Val','Some message','lobby')";
              ...
              dbConnection.query( queryString,
                function(err, results) {
                  ...
                  expect("In mercy's name, three days is all I need.").to.equal("In mercy's name, three days is all I need.");
